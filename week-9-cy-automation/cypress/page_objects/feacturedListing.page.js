class feacturedListingPage {
  ...
  get bedroomsBtn() {return cy.get('[role="button"]', { timeout: 30000 }).eq(0).should('be.visible')}
  ...
  get housePriceLoc() {return cy.get('[class="MuiBox-root css-6yrxxf"]', { timeout: 3000 }).eq(0)}
  get houseInfo() {return cy.get('[class="MuiCardContent-root css-lmipfk"]', { timeout: 3000 })}
